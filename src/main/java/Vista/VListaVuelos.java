 ...
 * @author DELL
 */
public class VListaVuelos extends javax.swing.JFrame {

    /**
     * Creates new form VListaVuelos
     */
    public VListaVuelos() {
        initComponents();
        new Controlador.ListaVuelosControlador(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VListaVuelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VListaVuelos().setVisible(true);
            }
        });
    }
