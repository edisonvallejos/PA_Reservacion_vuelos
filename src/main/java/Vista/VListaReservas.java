 ...
 * @author DELL
 */
public class VListaReservas extends javax.swing.JFrame {

    /**
     * Creates new form VListaReservas
     */
    public VListaReservas() {
        initComponents();
        new Controlador.ListaReservasControlador(this);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VListaReservas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VListaReservas().setVisible(true);
            }
        });
    }
